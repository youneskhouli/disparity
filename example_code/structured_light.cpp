...
int main(int argc, char **argv)
{
    ...
    fs["R"] >> R;
    fs["T"] >> T;
    cout << "cam1intrinsics" << endl
        << cam1intrinsics << endl;
    cout << "cam1distCoeffs" << endl
        << cam1distCoeffs << endl;
    cout << "cam2intrinsics" << endl
        << cam2intrinsics << endl;
    cout << "cam2distCoeffs" << endl
        << cam2distCoeffs << endl;
    cout << "T" << endl
        << T << endl
        << "R" << endl
    ...
    if (decoded)
    {
        ...
        resize(thresholded_disp, dst, Size(1224, 816));
        imshow("threshold disp otsu", dst);

        cout << "Converting the mats" << endl;
        dst.convertTo(dst, CV_32FC1);

        cout << "Saving exr files..." << endl;
